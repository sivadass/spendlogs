            ...
            <tr>
              <td style="padding: 32px">
                ...
                >
                  ...
                  <td>
                      <p
                        style="text-align: left; margin-top: 0px; margin-bottom: 24px; color: #666; font-size: 16px; line-height: 21px"
                      >
                        ${message}
                      </p>
                    </td>
                    ...
                    `<tr>
                      <td>
                        <p
                          style="text-align: left; margin-top: 0px; margin-bottom: 24px; color: #666; font-size: 16px; line-height: 21px"
                        >
                          <a style="text-align:center; text-decoration: none; display: block: padding: 8px 16px; max-width: 280px; color: #ffffff; background: #4caf50" href=${url}>Verify now!</a>
                        </p>
                      </td>
                    </tr>`}
                  <tr>
                  <td>
                      <p
                        style="text-left: center; margin-top: 0px; margin-bottom: 24px; color: #666; font-size: 16px; line-height: 21px"
                      >
                  ...
                  <tr>
                    <td>
                      <p
                        style="text-align: center; margin-top: 0; margin-bottom: 12px; color: #999; font-size: 14px; line-height: 21px"
                      >
                        Sent with ❤️ from
                        <a
